...
const LayoutProvider = ({children, auth = true, scrollable = false}) => {
    return (
        <Layout auth={auth} scrollable={scrollable}>
            <div className="relative flex flex-col h-full justify-center">
                ...
                <div className="flex flex-col justify-center items-center h-full" style={{zIndex: 2}}>
                {children}
                </div>
            </div>
        </Layout>
